...
| CP7: Dashboard | Live map; alert panel; login page; demo mode (POST /auth/demo, role claim, IP rate limit, WS expiry) | In progress — CP7b done (Next.js bootstrap, prettier, build/lint/typecheck pass) |
